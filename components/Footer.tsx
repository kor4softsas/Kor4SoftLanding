  ...
  return (
    <footer className="bg-slate-900 text-slate-300 relative overflow-hidden z-0">
      ...
      <div className="container mx-auto px-4 py-12 sm:py-16 max-w-7xl relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-8">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="flex gap-3">
              ...
              <a
                href="https://www.instagram.com/kor4soft/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-slate-800 hover:bg-slate-700 rounded-lg flex items-center justify-center transition-colors"
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#portfolio" className="text-sm hover:text-white transition-colors">
                  Proyectos
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2">
                ...
                <a href="mailto:kor4softsas@gmail.com" className="text-sm hover:text-white transition-colors">
              ...
              <li className="flex items-start gap-2">
                ...
                <span className="text-sm">+57 3181883915</span>
              </li>
              <li className="flex items-start gap-2">
                <svg className="w-5 h-5 text-slate-400 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {/* Bottom bar - Copyright y políticas */}
